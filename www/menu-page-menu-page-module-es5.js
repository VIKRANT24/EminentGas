...
var MenuPagePageModule = /** @class */ (function () {
    function MenuPagePageModule() {
    }
...
var MenuPagePage = /** @class */ (function () {
    ...
    MenuPagePage.prototype.openAdminLogin = function () {
        this.navCtrl.navigateForward('/super-admin');
    };
    MenuPagePage.prototype.openClientLogin = function () {
        this.navCtrl.navigateForward('/login');
    };
    MenuPagePage.ctorParameters = function () { return [

...
var DeviceActivitySuperadminPageModule = /** @class */ (function () {
    function DeviceActivitySuperadminPageModule() {
    }
    ...
    return DeviceActivitySuperadminPageModule;
}());
...
var DeviceActivitySuperadminPage = /** @class */ (function () {
    function DeviceActivitySuperadminPage(firebaseService) {
    ...
    DeviceActivitySuperadminPage.prototype.getAdminArm = function (user, pwd) {
        var _this = this;
    ...
    DeviceActivitySuperadminPage.prototype.getDevices = function (no_of_arms) {
        var _this = this;
    ...
    DeviceActivitySuperadminPage.ctorParameters = function () { return [
    ...
    return DeviceActivitySuperadminPage;
}());
...
//# sourceMappingURL=device-activity-superadmin-device-activity-superadmin-module-es5.js.map
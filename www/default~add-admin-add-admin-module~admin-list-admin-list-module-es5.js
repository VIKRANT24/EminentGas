...
var AddAdminPage = /** @class */ (function () {
    function AddAdminPage(loadingController, firebaseService, modalCtrl, events, http, alertController, toastController) {
    ...
    AddAdminPage.prototype.selectARM = function (event) {
        ...
        for (var i = 0; i < this.arm.length; i++) {
            var position = _assets_device_json__WEBPACK_IMPORTED_MODULE_4__.findIndex(function (c) { return c.deveui == _this.arm[i]; });
            if (this.selected_arms.findIndex(function (a) { return a.deveui == _this.arm[i]; }) < 0)
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        count = 0;
                        deviceUi = deviceui.deveui;
                        valueData = document.getElementById(item);
                        abc = valueData.children[0].children;
                        xyz = abc[0].children;
                        flatNo = xyz['flatNo'].value;
                        meterNo = xyz['meterNo'].value;
                        meterDefValue = xyz['meterDefValue'].value;
                        amrDefValue = xyz['amrDefValue'].value;
                        if (!(flatNo == "" || meterNo == "" || meterDefValue == "" || amrDefValue == "")) return [3 /*break*/, 2];
    ...
    AddAdminPage.prototype.editValue = function (item, deviceui) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var count, deviceUi, valueData, abc, xyz, flatNo, meterNo, meterDefValue, amrDefValue, toast, dataObj, toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        count = 0;

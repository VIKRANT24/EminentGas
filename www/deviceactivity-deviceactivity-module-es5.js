...
var DeviceactivityPageModule = /** @class */ (function () {
    function DeviceactivityPageModule() {
    }
    ...
    return DeviceactivityPageModule;
}());
...
var DeviceactivityPage = /** @class */ (function () {
    ...
    DeviceactivityPage.prototype.refresh = function () {
        this.rowData1 = [];
        this.rowData = [];
        this.datapackets = [];
        this.getdatapackets(this.device);
...
//# sourceMappingURL=deviceactivity-deviceactivity-module-es5.js.map